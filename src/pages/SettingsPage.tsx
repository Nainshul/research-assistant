...
import { ArrowLeft, Save, Loader2, Globe, Mail, CheckCircle, AlertCircle, Lock, MapPin } from 'lucide-react';
...
const SettingsPage = () => {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      // Update Supabase Auth user metadata for immediate UI updates
            ...
            {isOAuthUser ? (
              ...
              <div className="space-y-3">
                ...
                <p className="text-xs text-muted-foreground">
                  You'll need to verify your new email address to complete the change.
                </p>
              </div>
            )}
          </div>

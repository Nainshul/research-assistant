      ...
      <div className="relative overflow-hidden">
        ...
        <div className="px-6 py-12">
          ...
          <motion.div
             ...
             viewport={{ once: true }}
             className="mt-12 bg-orange-50 dark:bg-orange-950/20 rounded-2xl p-4 border border-orange-100 dark:border-orange-900/50 flex items-center gap-4"
          >
             <div className="w-10 h-10 rounded-full bg-orange-100 dark:bg-orange-900/50 flex items-center justify-center flex-shrink-0 animate-pulse">
                <span className="text-lg">📢</span>
             </div>
             <div className="flex-1 overflow-hidden">
                <p className="text-xs font-bold text-orange-600 dark:text-orange-400 uppercase tracking-wider mb-0.5">Live Insight</p>
                <div className="flex whitespace-nowrap overflow-hidden">
                   ...
                   >
                      ⚠️ High humidity detected in your region. Watch out for Fungal Blight in Tomatoes. • 🌧️ Monsoon tips: Ensure proper drainage today. • 🐛 New pest alert: Fall Armyworm reported nearby.
                   </motion.div>
                </div>
             </div>
          </motion.div>
